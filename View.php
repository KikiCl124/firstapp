 ...
 <div id="drawer-navigation" class="fixed bg-gray-200 top-0 left-0 z-40 w-64 h-screen p-4 overflow-y-auto transition-transform -translate-x-full dark:bg-gray-700" tabindex="-1" aria-labelledby="drawer-navigation-label">
   ...
   <div class="py-4 overflow-y-auto">
       <ul class="space-y-2 font-medium">
          ...
          <li>
             <a href="GuestView.php" class="text-decoration-none flex items-center p-2 text-gray-700  rounded-lg dark:text-red-300 hover:bg-gray-100 dark:hover:bg-gray-700 group">
          ...
          <li>  
             <a href="#" class=" text-decoration-none flex items-center p-2 text-gray-700  rounded-lg dark:text-red-300 group">
          ...
          <li>  
             <a href="logout.php" class=" text-decoration-none flex items-center p-2 text-gray-700  rounded-lg dark:text-red-300 group">
                <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-white group-hover:text-gray-500 dark:group-hover:text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 16">
                   <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 8h11m0 0L8 4m4 4-4 4m4-11h3a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-3"/>
                </svg>
    ...
    <div class="container" >
        ...
        <div class="song">
            <iframe style="border-radius:12px" src="https://open.spotify.com/embed/track/7LByQrLEpWzlMCdyjJKPOk?utm_source=generator" width="100%" height="82" frameBorder="0" alowfulllscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
        </div>
    <table class="table" >
  <thead>
    <tr>
      ...
      <td scope="col" class="edit-header dark:bg-red-500">Edit</td>
    </tr>
  </thead>
  <tbody>
    <?php
    ...
    if($result){
        while($row=mysqli_fetch_assoc($result)){
            ...
            if (in_array($fileExtension, $allowedExtensions)) {
                ...
                <td class="dark:bg-gray-600 "><img src="'.$profile.'" alt="Profile Image" width="100"></td>
                <td class="dark:bg-gray-600 dark:text-red-500">'.$nama.'</td>
                <td class="dark:bg-gray-600 dark:text-red-500">'.$nik.'</td>
                <td class="dark:bg-gray-600 dark:text-red-500">'.$nomor.'</td>
                <td class="dark:bg-gray-600 dark:text-red-500">'.$kelas.'</td>
                <td class="edit-header dark:bg-gray-600">
